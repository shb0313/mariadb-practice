...
-- 3-1) 단일행 연산자: =, >, <, >=, <=, <>, !=
-- 실습문제1: 현재 전체 사원의 평균 연봉보다 적은 급여를 받는 사원의 이름과 급여를 출력
select avg(salary)
	from salaries
...
-- 실습문제2: 현재 가장 적은 평균 급여의 직책과 그 평균 급여 출력
-- 직책별 평균 급여
...
-- 실습문제3: 현재 급여가 50000 이상인 직원의 이름과 급여를 출력
-- sol1: join
select a.first_name, b.salary
	from employees a, salaries b
    where a.emp_no = b.emp_no
